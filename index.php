...
<body>
    <div class="main">
            ...
            <div class="header__navbar">
                <ul class="header__navbar--list">
                    <li class="header__navbar--item">
                        <i class="far fa-bell"></i> Thông báo</li>
                    <li class="header__navbar--item">
                        <i class="far fa-question-circle"></i> Trợ giúp</li>
        ...
        <div class="content">
            <!--Sản phẩm dưỡng da-->
            <div class="text_title">Sản phẩm dưỡng da</div>
            <hr>
            <div class="content1">
                <div class="content12" >
                    <img src="./images/bo-cham-soc-da-rau-ma-cho-da-dau-mun_sp2x.jpg" alt="" width="300px">
                    <p>Nước hoa hồng dưỡng da</p>
                    <p style="color: green";>140.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/64510560-5663-435b-b2a9-aefdd7a76b84.webp" width="300px">
                    <p>Son kem dưỡng môi</p>
                    <p style="color: green;">198.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/88a97c61-72c9-4c42-a97c-866b5be4c8c9.webp" alt="" width="300px">
                    <p>Kem dưỡng da toàn thân</p>
                    <p style="color: green";>200.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/combo-kem-chong-nang-kem-nen-kem-ma_sp2x.png" alt="" width="300px">
                    <p>Kem chống nắng dưỡng da</p>
                    <p style="color: green";>500.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
            </div>
            <!--Kem dưỡng da-->
            <div class="text_title" style="margin-top: 50px;">Kem dưỡng da</div>       
            <hr>
            <div class="content1">
                <div class="content12" >
                    <img src="./images/kem-duong-da-tay-mui-dao_sp2x.png" alt="" width="300px">
                    <p>Kem dưỡng da trà đào</p>
                    <p style="color: green";>400.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/f2b31814-11c4-4468-aff5-1dd4c8ac6e54.webp" alt="" width="300px">
                    <p>Mặt nạ dưỡng da trà xanh</p>
                    <p style="color: green;">450.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/kem-duong-am-to-tam_sp2x.jpg" alt="" width="300px">
                    <p>Kem dưỡng ẩm ngừa lão hóa</p>
                    <p style="color: green";>200.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
                <div class="content12" >
                    <img src="./images/saem.webp" alt="" width="300px">
                    <p>Kem dưỡng lông mày</p>
                    <p style="color: green";>500.000đ</p>
                    <button class="btn_mua">Mua hàng</button>
                </div>
            </div>
            ...
            <div class="new">
                <div class="content13" >
                    <img src="./images/6096652077f59-nhung-loai-kem-chong-lao-hoa-tot-nhat.jpg">
